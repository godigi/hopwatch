...
enum GalleryMode {
    ...
    private static func screens(_ coordinator: HopwatchCoordinator) -> [Screen] {
    ...
    private static func renderAll(into directory: String) async {
        ...
        print("hopwatch gallery → \(directory)")
    ...
    private static func hydrate(_ coordinator: HopwatchCoordinator) async {
