...
/// Hopwatch.app — a menu-bar client for the hopwatch CLI.
///
...
@main
struct HopwatchApp: App {

    @State private var coordinator = HopwatchCoordinator()
    ...
    var body: some Scene {
        ...
        Window("Hopwatch", id: WindowID.dashboard) {
            MainWindow()
                .environment(coordinator)
                .environment(coordinator.appSettings)
        ...
        Window("Welcome to Hopwatch", id: WindowID.onboarding) {
            OnboardingView()
                .environment(coordinator)
                .environment(coordinator.appSettings)
        }
...
struct MenuBarLabel: View {
    @Bindable var coordinator: HopwatchCoordinator
